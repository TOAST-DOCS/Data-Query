...
* 클러스터에 설정된 인스턴스 유형과 노드 수를 확인할 수 있습니다.
    * 유형에 대한 설명이나 설정에서 제공되는 목록 이외의 유형은 [유형 및 요금](https://www.nhncloud.com/kr/pricing/by-service?c=Data%20%26%20Analytics&s=DataQuery)에서 확인할 수 있습니다.
* 인스턴스 유형과 워커 수를 변경할 수 있습니다.
    * 워커의 수는 최소 1개에서 최대5개까지 설정할 수 있습니다.
