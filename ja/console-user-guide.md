...
* **データソース追加**をクリックし、ダイアログボックスにObject Storage情報を入力します。
    ...
    * アクセスキー、秘密鍵、エンドポイント
        ...
        * エンドポイントはObject Storageガイドのリージョン別[S3 APIエンドポイント](https://docs.toast.com/ko/Storage/Object%20Storage/ko/s3-api-guide/#aws-cli)をご覧ください。
    * バケット名
...
* クエリエディタで実行されたクエリ結果を確認できます。
    * データサイズに応じて最大5,000個の制限された結果を提供します。
