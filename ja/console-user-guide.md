...
| アクセスキー | O | Data Lake Storageで発行した認証情報 | • Data Lake Storageの認証情報発行方法は、[Data Lake Storageコンソール使用ガイド](https://docs.nhncloud.com/ko/Data%20&%20Analytics/Data%20Lake%20Storage/ko/console-user-guide/#_10)を参照してください。 |
| シークレットキー | O | Data Lake Storageで発行した認証情報 |  |
| バケット名 | O | 基本テーブル情報や管理テーブル情報、データを保存するために使用する基本バケット。 | • バケットが存在しない場合、データソースの登録時にバケットを一緒に作成します。<br>• 使用可能なバケット名は[Data Lake Storageコンソール使用ガイド](https://docs.nhncloud.com/ko/Data%20&%20Analytics/Data%20Lake%20Storage/ko/console-user-guide/#_7)を参照してください。<br>• 連携する既存のデータはdataquery-warehouseコンテナの外部に存在できます。 |
